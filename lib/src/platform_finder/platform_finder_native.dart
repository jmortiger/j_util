...
Platform getPlatform() => switch (io.Platform.operatingSystem) {
      ...
      _ => throw UnimplementedError(
          "Platform.operatingSystem: ${io.Platform.operatingSystem} It shouldn't be possible to see this error unless the # of supported platforms increased or you accessed this function's file directly. Use the library (`import 'package:j_util/platform_finder.dart'`) to access."),
    };
// Guarenteed to work
